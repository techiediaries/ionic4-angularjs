...
var MenuController = /** @class */ (function () {
    ...
    MenuController.prototype.get = function (menuId) {
        ...
        if (menuId === 'left' || menuId === 'right') {
            ...
            menu = this.menus.find(function (m) { return m.side === menuId && m.enabled; });
            if (menu) {
                return menu;
            }
            // didn't find a menu side that is enabled
            // so try to get the first menu side found
            return this.menus.find(function (m) { return m.side === menuId; }) || null;
        }
        else if (menuId) {
            // the menuId was not left or right
            // so try to get the menu by its "id"
            return this.menus.find(function (m) { return m.id === menuId; }) || null;
        }
        // return the first enabled menu
        menu = this.menus.find(function (m) { return m.enabled; });
        if (menu) {
            return menu;
        }
    ...
    MenuController.prototype.getOpen = function () {
        return this.menus.find(function (m) { return m.isOpen(); });
    };
    /**
     ...
     * @hidden
     */
    MenuController.prototype.registerAnimation = function (name, cls) {
    ...
    MenuController.prototype.create = function (type, menuCmp) {
        var animationBuilder = this.menuAnimations[type];

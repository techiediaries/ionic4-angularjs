    ...
    Searchbar.prototype.render = function () {
        return [
            h("div", { "c": { "searchbar-input-container": true } },
                ...
                h("input", { "c": { "searchbar-input": true }, "o": { "input": this.inputChanged.bind(this), "blur": this.inputBlurred.bind(this), "focus": this.inputFocused.bind(this) }, "a": { "autoComplete": this.autocomplete }, "p": { "placeholder": this.placeholder, "type": this.type, "value": this.value, "autoCorrect": this.autocorrect, "spellCheck": this.spellcheck } }),

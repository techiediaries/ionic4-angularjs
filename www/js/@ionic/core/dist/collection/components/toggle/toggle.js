var Toggle = /** @class */ (function () {
    ...
    Toggle.prototype.render = function () {
        return (h("ion-gesture", { "p": { "canStart": this.canStart.bind(this), "onStart": this.onDragStart.bind(this), "onMove": this.onDragMove.bind(this), "onEnd": this.onDragEnd.bind(this), "onPress": this.toggle.bind(this), "gestureName": 'toggle', "gesturePriority": 30, "type": 'pan,press', "direction": 'x', "threshold": 0, "attachTo": 'parent' } },

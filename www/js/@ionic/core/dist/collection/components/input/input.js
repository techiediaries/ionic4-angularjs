...
var Input = /** @class */ (function () {
    ...
    */
    ...
    Input.prototype.render = function () {
        ...
        return [
            h("input", { "c": themedClasses, "o": { "blur": this.inputBlurred.bind(this), "input": this.inputChanged.bind(this), "focus": this.inputFocused.bind(this), "keydown": this.inputKeydown.bind(this) }, "a": { "aria-disabled": this.disabled ? 'true' : false, "autoComplete": this.autocomplete, "autoFocus": this.autofocus, "disabled": this.disabled }, "p": { "accept": this.accept, "autoCapitalize": this.autocapitalize, "autoCorrect": this.autocorrect, "checked": this.checked, "inputMode": this.inputmode, "min": this.min, "max": this.max, "minLength": this.minlength, "maxLength": this.maxlength, "multiple": this.multiple, "name": this.name, "pattern": this.pattern, "placeholder": this.placeholder, "results": this.results, "readOnly": this.readonly, "required": this.required, "spellCheck": this.spellcheck, "step": this.step, "size": this.size, "type": this.type, "value": this.value } }),
